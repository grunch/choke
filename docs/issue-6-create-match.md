...
Implement the match creation flow: a form screen where users input fighter names, match duration, and fighter colors, then publish the initial kind 31925 Nostr event with status `waiting`.
