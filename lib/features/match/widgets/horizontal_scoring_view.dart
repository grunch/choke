...
/// Horizontal landscape mode optimized for fast dual-fighter scoring
///
/// Layout:
/// - Left panel (80%): Scoring controls for both fighters
/// - Right panel (20%): Timer, scores, and match controls
///
/// Design goals:
/// - 100% screen coverage (no wasted space)
/// - No tab switching (both fighters visible)
/// - Responsive (adapts to all mobile screen sizes)
/// - Modern UI (badges, colored backgrounds, high contrast)
class HorizontalScoringView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SafeArea(
      child: Row(
        children: [
          // Left panel: Dual scoring (80% width)
          Expanded(
            flex: 4,
            child: Container(
          ...
          // Right panel: Timer + scores (20% width)
          Expanded(
            flex: 1,
  ...
  /// Build fighter scoring panel (one row with all controls)
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return Column(
            ...
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              // Match ID badge (compact, above score)
              Container(
              ...
              // Fighter 1 score (with colored background)
              Container(
              ...
              // Fighter 2 score (with colored background)
              Container(
                padding: EdgeInsets.symmetric(
                  horizontal: scoreSize * 0.3,
                  vertical: scoreSize * 0.15,
